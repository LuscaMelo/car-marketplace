...
export default function Home() {
  ...
  return (
    <main className="xl:flex md:w-[88%]">
      <section className="xl:w-[65%] lg:p-12 md:p-8 pt-16">
        ...
        <div className='h-[500px] md:h-[300px] mb-16 md:rounded-3xl mt-6 bg-[url("../../public/car-banner.jpg")] overflow-hidden bg-cover bg-center hover:scale-[1.02] duration-500'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-4 mt-8 w-full px-8 md:px-0">
